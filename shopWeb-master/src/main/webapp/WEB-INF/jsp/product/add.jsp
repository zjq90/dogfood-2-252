            ...
            <div class="form-container">
                <form action="${pageContext.request.contextPath}/product/add" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" id="pname" name="pname" placeholder="请输入商品名称" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="sprice">市场价（元）</label>
                        <input type="number" id="sprice" name="sprice" step="0.01" min="0" placeholder="请输入市场价" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="cprice">销售价（元）</label>
                        <input type="number" id="cprice" name="cprice" step="0.01" min="0" placeholder="请输入销售价" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="number">库存数量</label>
                        <input type="number" id="number" name="number" min="0" placeholder="请输入库存数量" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="pdesc" name="pdesc" placeholder="请输入商品描述"></textarea>
                    </div>
